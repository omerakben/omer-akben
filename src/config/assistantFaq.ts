...
export const FACT_BANK = {
  tmay: {
    present:
      "I'm an AI Engineer & Full-Stack dev focused on TypeScript/React and Python/FastAPI/Django. Lately I've shipped agentic/RAG features with OpenAI/Claude + LangGraph.",
  ...
  signatureProject: {
    name: "Ozzy AI Twin",
    description:
      "Goal: side-panel agent for my portfolio. I designed tool use (Playwright MCP, web browse, RAG on my docs), built a FastAPI backend + Next.js UI, and added eval tests in CI. Result: e.g., sub-1s retrieval, ~95% task success on scripted flows.",
  },
} as const;
