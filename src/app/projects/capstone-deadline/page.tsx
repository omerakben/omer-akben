...
export const metadata: Metadata = {
  ...
  description: "A comprehensive case study of DEADLINE, a production-deployed developer operations platform with zero-signup demo mode and polymorphic artifact management.",
};
    ...
    <main className="min-h-screen bg-surf-0 py-20">
      <div className="max-w-4xl mx-auto px-4 md:px-8">
        ...
        <div className="bg-surf-1 border border-border-line rounded-[20px] p-8 mb-8">
          ...
          <p className="text-text-2 leading-relaxed mb-4">
            I developed <strong className="text-text-1">DEADLINE</strong>, a full-stack developer operations platform that serves as a unified command center for development artifacts. The platform features a <strong className="text-text-1">zero-signup demo mode</strong> that allows recruiters and evaluators to experience the full application instantly using pre-populated sample workspaces.
          </p>
          <p className="text-text-2 leading-relaxed">
            Built with Django 5 + PostgreSQL (Railway) and Next.js 15 (Vercel), DEADLINE implements a <strong className="text-text-1">polymorphic artifact system</strong> that handles environment variables, AI prompts, and documentation links with environment-aware management (DEV/STAGING/PROD), comprehensive tagging, and masked sensitive values for security. The UI underwent rigorous Playwright visual testing, achieving an <strong className="text-text-1">A- grade (92/100)</strong> with professional micro-interactions.
          </p>
        </div>
          ...
          <div className="mb-8">
            <div className="bg-surf-1 border border-border-line rounded-[20px] overflow-hidden">
              <div className="p-4 border-b border-border-line">
                <h3 className="text-lg font-bold text-text-1">Application Architecture</h3>
              </div>
              <div className="p-8 flex items-center justify-center min-h-[400px] text-text-3">
                <div className="text-center">
                  ...
                  <p className="text-sm mt-2">Django 5 + Railway ↔ Next.js 15 + Vercel</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-surf-1 border border-border-line rounded-[20px] p-8 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-text-1 mb-2">Polymorphic Artifact System</h3>
                <p className="text-text-2">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-text-1 mb-2">Security & Privacy</h3>
                <p className="text-text-2">
                  Masked sensitive values (API keys, secrets) with reveal-on-hover functionality. Workspace isolation ensures multi-tenancy with Firebase Authentication. Session-based demo tokens with automatic expiration. Environment-aware artifact visibility prevents production secret exposure.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-text-1 mb-2">Workspace Management</h3>
                <p className="text-text-2">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-text-1 mb-2">UI/UX Excellence</h3>
                <p className="text-text-2">
        ...
        <div className="bg-surf-1 border border-border-line rounded-[20px] p-8 mb-8">
          <h2 className="text-2xl font-bold text-text-1 mb-4">Technical Implementation</h2>
          <div className="space-y-4">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                ...
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">DRF</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">PostgreSQL</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">Railway</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">Alembic</span>
              </div>
            </div>

            <div>
              <h3 className="text-lg font-bold text-text-1 mb-2">Frontend Stack</h3>
              <p className="text-text-2 mb-2">
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">Next.js 15</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">React 19</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">TypeScript</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">Tailwind CSS</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">Vercel</span>
              </div>
            </div>

            <div>
              <h3 className="text-lg font-bold text-text-1 mb-2">Quality Assurance</h3>
              <p className="text-text-2 mb-2">
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">Playwright</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">ESLint</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">TypeScript</span>
                <span className="px-2 py-1 bg-surf-2 text-text-3 rounded text-sm border border-border-line">Visual Testing</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Development Process */}
        <div className="bg-surf-1 border border-border-line rounded-[20px] p-8 mb-8">
          <h2 className="text-2xl font-bold text-text-1 mb-4">Development Process</h2>
          <div className="space-y-4">
            <div className="flex gap-3">
              <CheckCircle2 className="w-5 h-5 text-brand-primary flex-shrink-0 mt-0.5" />
              <div>
                <strong className="text-text-1">Phase 1: Architecture & Design</strong>
                <p className="text-text-2 text-sm mt-1">Designed Django models with polymorphic artifact system. Planned REST API endpoints and authentication flow. Created Next.js frontend scaffolding with App Router structure.</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <CheckCircle2 className="w-5 h-5 text-brand-primary flex-shrink-0 mt-0.5" />
              <div>
                <strong className="text-text-1">Phase 2: Backend Implementation</strong>
                <p className="text-text-2 text-sm mt-1">Built Django REST API with DRF serializers. Implemented Firebase Admin SDK authentication middleware. Created PostgreSQL schema with Alembic migrations. Deployed to Railway with environment configuration.</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <CheckCircle2 className="w-5 h-5 text-brand-primary flex-shrink-0 mt-0.5" />
              <div>
                <strong className="text-text-1">Phase 3: Frontend Development</strong>
                <p className="text-text-2 text-sm mt-1">Built Next.js pages with TypeScript. Integrated Firebase Authentication with session management. Created React Hook Form validation for all artifact types. Implemented Tailwind CSS styling with responsive design.</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <CheckCircle2 className="w-5 h-5 text-brand-primary flex-shrink-0 mt-0.5" />
              <div>
                <strong className="text-text-1">Phase 5: Visual Testing & Optimization</strong>
                <p className="text-text-2 text-sm mt-1">Conducted Playwright visual testing across all viewports. Implemented Priority 1 improvements: hover states, loading feedback, focus rings. Validated mobile responsiveness (375px, 768px, 1512px). Achieved A- grade with zero ESLint warnings.</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <CheckCircle2 className="w-5 h-5 text-brand-primary flex-shrink-0 mt-0.5" />
              <div>
                <strong className="text-text-1">Phase 6: Production Deployment</strong>
                <p className="text-text-2 text-sm mt-1">Deployed backend to Railway with PostgreSQL provisioning. Deployed frontend to Vercel with custom domain. Configured CORS and environment variables. Tested end-to-end authentication and demo mode in production.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Results & Impact */}
        <div className="bg-surf-1 border border-border-line rounded-[20px] p-8 mb-8">
          <h2 className="text-2xl font-bold text-text-1 mb-4">Results & Impact</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-surf-2 border border-border-line rounded-lg p-6">
              <div className="text-3xl font-bold text-brand-primary mb-2">A-</div>
              <div className="text-text-1 font-medium">UI/UX Grade</div>
              <div className="text-text-3 text-sm mt-1">92/100 in Playwright visual testing</div>
            </div>
            ...
            <div className="bg-surf-2 border border-border-line rounded-lg p-6">
              ...
              <div className="text-text-3 text-sm mt-1">Zero ESLint warnings or TypeScript errors</div>
            </div>

            <div className="bg-surf-2 border border-border-line rounded-lg p-6">
              <div className="text-3xl font-bold text-brand-primary mb-2">3</div>
              <div className="text-text-1 font-medium">Artifact Types</div>
              <div className="text-text-3 text-sm mt-1">ENV_VAR, PROMPT, DOC_LINK polymorphism</div>
            </div>
            ...
            <div className="bg-surf-2 border border-border-line rounded-lg p-6">
              ...
              <div className="text-text-3 text-sm mt-1">Validated across all device sizes</div>
            </div>
          </div>

          <p className="text-text-2 mt-6 leading-relaxed">
            DEADLINE demonstrates production-ready full-stack development with a focus on <strong className="text-text-1">developer experience</strong>, <strong className="text-text-1">recruiter accessibility</strong>, and <strong className="text-text-1">security-first design</strong>. The zero-signup demo mode removes friction for technical evaluators while showcasing real-world DevOps workflows.
          </p>
        </div>
