...
export const navigatePageSchema = z.object({
  ...
  reason: z
    .string()
    .describe("Brief explanation of why this page is relevant to the user's query"),
});
...
export type DownloadCertificateInput = z.infer<typeof downloadCertificateInputSchema>;
...
export type NavigatePageContract = z.infer<typeof navigatePageSchema>;
