...
export const technologiesRow1: Technology[] = [
  ...
  { name: "Node.js", iconName: "nodedotjs", colorClass: "text-brand-node" },
  {
    name: "PostgreSQL",
    iconName: "postgresql",
    colorClass: "text-brand-postgresql",
  },
...
export const technologiesRow2: Technology[] = [
  {
    name: "JavaScript",
    iconName: "javascript",
    colorClass: "text-brand-javascript",
  },
  ...
  { name: "Redis", iconName: "redis", colorClass: "text-brand-redis" },
  {
    name: "Kubernetes",
    iconName: "kubernetes",
    colorClass: "text-brand-kubernetes",
  },
  {
    name: "TensorFlow",
    iconName: "tensorflow",
    colorClass: "text-brand-tensorflow",
  },
