...
export const projects: Project[] = [
  ...
  // TIER 2: Ready to Deploy
  {
    ...
    technologies: ["Next.js 15", "React 19", "TypeScript", "Tailwind CSS", "Fuse.js"],
    role: "Full-Stack",
    category: "tools",
    featured: true,
  ...
  },
  {
    ...
    description: "Production-deployed developer operations platform with zero-signup demo mode, achieving A- (92/100) UI/UX grade in Playwright visual testing. Manages polymorphic artifacts (ENV_VAR, PROMPT, DOC_LINK) across dev/staging/prod environments with masked sensitive values and workspace isolation.",
    ...
    technologies: ["Django 5", "Next.js 15", "React 19", "PostgreSQL", "Railway", "Vercel", "Django REST Framework", "TypeScript", "Tailwind CSS", "Firebase Auth"],
    role: "Full-Stack",
    category: "tools",
    featured: true,
