**OMER AKBEN**  
Raleigh, NC | [me@omerakben.com](mailto:me@omerakben.com) | (267) 512-4566 | [linkedin.com/in/omerakben](http://linkedin.com/in/omerakben) | [github.com/omerakben](http://github.com/omerakben) | [omerakben.com](http://omerakben.com)
...
- **Data & Databases:** PostgreSQL, SQL Server, MongoDB, Redis, Schema Design, Data Migrations, Data Validation, SQL Queries & Optimization  
- **Cloud/DevOps:** AWS (Lambda, API Gateway, S3), Azure (Entra ID, Azure DevOps), Docker, Kubernetes (environment parity), Git/GitHub, CI/CD (GitHub Actions, Jenkins, Azure Pipelines), Observability (logging, metrics, tracing)  
- **QA/SDET:** Playwright (End-to-End/API), Selenium WebDriver, Java, JUnit, TestNG, REST Assured, Postman, Newman, Cucumber/SpecFlow/BDD, JMeter (performance testing), Cypress (exposure), Appium (mobile testing), Test Strategy & Planning  
- **Engineering Practices:** System Design, Test-Driven Development (TDD), Behavior-Driven Development (BDD), Shift-Left Quality, Code Reviews, Technical Documentation, Mentoring, Agile/Scrum

**PROFESSIONAL EXPERIENCE**

**AI Full-Stack Software Engineer — Freelance | Remote (Raleigh, NC) | January 2024 – Present**  
...
**Technologies:** TypeScript, Next.js, React, Node.js, Python, FastAPI, Django, OpenAI API, Anthropic Claude API, LangChain, LangGraph, Playwright, Jest, Docker, GitHub Actions, Azure DevOps, PostgreSQL (pgvector), FAISS, MongoDB, Redis, AWS (Lambda, API Gateway, S3), Azure (Entra ID), Zapier, n8n, Git

- **Test Automation Architect (SDET) — Oteemo | Remote | February 2025 – September 2025**
...
**Technologies:** C\#, .NET, Playwright, MSTest, RestSharp, Jenkins, Azure DevOps, Docker, SQL Server, Git, NuGet, Selenium WebDriver

**QA Engineer — Engineering Consulting Services (ECS) | Raleigh, NC (Hybrid) | April 2023 – January 2024**  
...
**Technologies:** C\#, MSTest, Selenium WebDriver, RestSharp, Postman, Newman, Azure DevOps, Microsoft Dynamics 365, SQL Server, Git

**SDET / QA Test Automation Engineer — Xsolis | Remote | October 2022 – April 2023**  
...
**Technologies:** C\#, .NET, Selenium WebDriver, SpecFlow (BDD), xUnit, SQL Server, Azure, Postman, Jira, Confluence, qTest, Git

**SDET / QA Automation Engineer — Fannie Mae | Remote | March 2021 – September 2022**  
...
**Technologies:** Java, Selenium WebDriver, TestNG, REST Assured, Jenkins, Selenium Grid, Maven, Git, SQL, REST APIs

**PROJECTS**

**AI Chat Platform (University) — Next.js/TypeScript • FastAPI • OpenAI/Claude • LangChain/LangGraph • RAG (pgvector/FAISS) • Microsoft Entra ID • Playwright**  
Multi-tenant conversational AI platform with sophisticated agentic workflows, including tool/function calling, conversation memory with context window management, and content guardrails for appropriate responses. Implements comprehensive retrieval evaluation metrics tracked in CI, including answer accuracy, context precision/recall, and latency percentiles. Features role-based access control (RBAC), comprehensive audit logging, and administrative dashboards for content management and analytics. Full end-to-end test coverage using Playwright with visual regression testing and API contract validation.

**Portfolio ([omerakben.com](http://omerakben.com)) — Next.js/TypeScript • Vercel • Playwright**  
Production personal portfolio demonstrating modern web development practices, including performance budgets with Lighthouse CI integration, and maintaining scores above 95 across all metrics (Performance, Accessibility, Best Practices, SEO). Implements Core Web Vitals monitoring (LCP, FID, CLS) with alerting on degradation. Comprehensive Playwright smoke and regression test suites running on every deployment. Integrated analytics for user experience insights and A/B testing capabilities.

**tuel ([npm packages](https://www.npmjs.com/~tuel)) — React • TypeScript • Storybook • CI/CD**  
Open-source, tree-shakable React animation component library with full TypeScript support, providing type-safe APIs. Published on npm with comprehensive Storybook documentation, interactive examples, and usage guides. Implements continuous integration testing with automated version bumping and publishing. Bundle size optimized with code splitting and ESM format and used in production on personal portfolio and multiple demonstration projects.
...
**SYSTEM DESIGN & QUALITY ENGINEERING PRACTICES**

**System Design & Architecture:** Experienced in designing scalable, maintainable systems including API versioning strategies, authentication and authorization (OAuth2/JWT/RBAC), rate limiting and throttling, retry policies with exponential backoff, idempotent operation design, multitenancy with data isolation, caching strategies (Redis/in-memory), structured error handling with clear error taxonomies, and observability through comprehensive logging, metrics collection, and distributed tracing.

**AI/LLM Architecture:** Implements end-to-end RAG pipelines, including document ingestion and preprocessing, vector embedding generation and indexing (pgvector/FAISS/Pinecone), hybrid retrieval that combines vector similarity with keyword search, context assembly, and prompt engineering, LLM generation with LangChain/LangGraph state management, and comprehensive evaluation frameworks. Focuses on cost optimization through prompt caching and efficient context management, latency optimization through parallel processing and caching strategies, and quality assurance through offline evaluation metrics, driving continuous improvements in prompt and retrieval performance.

**Test Strategy & Quality Engineering:** Advocates for risk-based test coverage prioritization, test pyramid architecture balancing unit/integration/E2E tests, contract testing for microservices to prevent breaking changes, comprehensive Playwright E2E and API test suites, REST Assured for backend API validation, Newman integration for Postman collection automation, Selenium Grid for parallel cross-browser testing, flaky test detection and quarantine mechanisms, and shift-left testing practices. Implements Test-Driven Development (TDD) and Behavior-Driven Development (BDD) methodologies to ensure quality is built into the development process from the beginning.